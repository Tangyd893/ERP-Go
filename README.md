...
本节基于 2026-06-05 对仓库的检查更新。详细缺口与任务优先级见 [docs/待办清单.md](docs/待办清单.md)。
...
- 事件：Order 服务在 DB 就绪时已启动 **进程内 Outbox 轮询** 与 P4 出库编排；RabbitMQ **Consumer 独立 worker 尚未接入**。详见待办清单「事件处理现状」表。
